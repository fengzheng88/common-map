...
@Data
public class BaiduGeocodingResultPO {
    private Coordinate location;
    private int precise; //1：精确查找，0：模糊查找
    /**
     * 描述打点绝对精度（即坐标点的误差范围）。
    ...
    /**
     * 能精确理解的地址类型，
     * 包含：UNKNOWN、国家、省、城市、区县、乡镇、村庄、道路、地产小区、商务大厦、政府机构、
     * 交叉路口、商圈、生活服务、休闲娱乐、餐饮、宾馆、购物、金融、教育、医疗 、工业园区 、旅游景点 、
     * 汽车服务、火车站、长途汽车站、桥 、停车场/停车区、港口/码头、收费区/收费站、飞机场 、机场 、收费处/收费站 、加油站、绿地、门址
     */
